    ...
    return (
        <section id="projects" className='my-5'>
            <div className='flex flex-wrap justify-center shadow-xl'>
                ...
                <div key={projects.id} className='md:w-1/3 lg:w-1/2 p-4'>
                    <div className='bg-gray-600 rounded-lg shadow-lg p-3'>
                        ...
                        <a href={projects.link} id="button" className='text-blue-500 inline-block hover:text-blue-400 mt-4 p-5 m-5'>View Project</a>
                        <img
                            alt="gallery"

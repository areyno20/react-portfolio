            ...
            <div className='flex flex-wrap justify-center'>
                <div className='w-1/2 md:w-1/3 lg:w-1/2 p-4'>
                    <div className='bg-gray-600 rounded-lg shadow-lg p-3'>
                        ...
                        <a href='https://stocktistics.herokuapp.com/login' className='text-blue-500 inline-block hover:text-blue-400 mt-4'>View Project</a>
                    </div>
                </div>
                <div className='w-1/2 md:w-1/3 lg:w-1/2 p-4'>
                    <div className='bg-gray-600 rounded-lg shadow-lg p-3'>
                        ...
                        <a href='https://areyno20.github.io/Fresh-Bakery/' className='text-blue-500 inline-block hover:text-blue-400 mt-4'>View Project</a>
                    </div>
                </div>
                <div className='w-1/2 md:w-1/3 lg:w-1/2 p-4'>
                    <div className='bg-gray-600 rounded-lg shadow-lg p-3'>
                        ...
                        <a href='https://github.com/areyno20/Social-Network-API' className='text-blue-500 inline-block hover:text-blue-400 mt-4'>View Project</a>
                    </div>
                </div>
                <div className='w-1/2 md:w-1/3 lg:w-1/2 p-4'>
                    <div className='bg-gray-600 rounded-lg shadow-lg p-3'>
                        ...
                        <a href='https://just-another-text-editor.herokuapp.com/' className='text-blue-500 inline-block hover:text-blue-400 mt-4'>View Project</a>
                    </div>
                </div>
                <div className='w-1/2 md:w-1/3 lg:w-1/2 p-4'>
                    <div className='bg-gray-600 rounded-lg shadow-lg p-3'>
                        ...
                        <a href='https://github.com/areyno20/README-Generator' className='text-blue-500 inline-block hover:text-blue-400 mt-4'>View Project</a>
                    </div>
                </div>
                <div className='w-1/2 md:w-1/3 lg:w-1/2 p-4'>
                    <div className='bg-gray-600 rounded-lg shadow-lg p-3'>
                        ...
                        <a href='https://github.com/areyno20/Note-Taker' className='text-blue-500 inline-block hover:text-blue-400 mt-4'>View Project</a>
                    </div>
                </div>
            </div>
        </section>
